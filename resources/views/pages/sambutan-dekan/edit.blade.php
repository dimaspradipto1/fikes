...
@section('title', 'Edit Sambutan Dekan')

@section('content')
<div class="pagetitle">
    <h1>Edit Sambutan Dekan</h1>
    <nav>
        <ol class="breadcrumb">
        ...
        <div class="card shadow-sm">
            <div class="card-header py-3">
                <h5 class="mb-0 fw-semibold">
                    <i class="bi bi-pencil-square me-2 text-warning"></i>Form Edit Sambutan Dekan
                </h5>
            </div>
            <div class="card-body pt-4">
                ...
                <form action="{{ route('sambutan-dekan.update', $sambutanDekan->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        @if ($sambutanDekan->url_photo)
                            <div class="mb-2 d-flex align-items-center gap-3">
                                <img id="img-current"
                                     src="{{ Storage::disk('public')->url($sambutanDekan->url_photo) }}"
                                     alt="Foto Dekan Saat Ini"
                        ...
                        <div class="form-text">Format: JPG, JPEG, PNG, WEBP. Kosongkan jika tidak ingin mengganti foto.</div>
                        @error('photo')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url"
                               ...
                               value="{{ old('url_video', $sambutanDekan->url_video) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="deskripsi"
                                  name="deskripsi"
                                  class="@error('deskripsi') is-invalid @enderror">{{ old('deskripsi', $sambutanDekan->deskripsi) }}</textarea>
                    </div>
