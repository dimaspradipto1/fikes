    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
           <li>
            <a href="{{ route('sejarah-ibnu-sina.index') }}" class="{{ request()->routeIs('sejarah-ibnu-sina.*') ? 'active' : '' }}">
              <i class="bi bi-circle"></i><span>Sejarah YAPISTA</span>
            </a>
          </li>
          <li>
            <a href="{{ route('sambutan-dekan.index') }}">
              <i class="bi bi-circle"></i><span>Sambuatan Dekan</span>
            </a>
          </li>
         
          <li>
            <a href="{{ route('visi-misi.index') }}" class="{{ request()->routeIs('visi-misi.*') ? 'active' : '' }}">
              <i class="bi bi-circle"></i><span>Visi Misi</span>
            </a>
          </li>
          <li>
            <a href="{{ route('struktur.index') }}" class="{{ request()->routeIs('struktur.*') ? 'active' : '' }}">
              <i class="bi bi-circle"></i><span>Struktur Organisasi</span>
            </a>
          </li>
          <li>
            <a href="{{ route('profil-pimpinan.index') }}" class="{{ request()->routeIs('profil-pimpinan.*') ? 'active' : '' }}">
