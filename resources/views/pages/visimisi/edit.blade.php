        ...
        <div class="card shadow-sm">
            <div class="card-header py-3">
                <h5 class="mb-0 fw-semibold">
                    <i class="bi bi-pencil-square me-2 text-warning"></i>Form Edit Visi Misi
                </h5>
            </div>
            <div class="card-body pt-4">
                ...
                <form action="{{ route('visi-misi.update', $visiMisi->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="visi"
                                  name="visi"
                                  class="@error('visi') is-invalid @enderror">{{ old('visi', $visiMisi->visi) }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="misi"
                                  name="misi"
                                  class="@error('misi') is-invalid @enderror">{{ old('misi', $visiMisi->misi) }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="tujuan"
                                  name="tujuan"
                                  class="@error('tujuan') is-invalid @enderror">{{ old('tujuan', $visiMisi->tujuan) }}</textarea>
                    </div>
