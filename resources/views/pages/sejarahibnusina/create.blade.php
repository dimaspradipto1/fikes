...
@section('title', 'Tambah Sejarah Ibnu Sina')

@section('content')
<div class="pagetitle">
    <h1>Tambah Sejarah Ibnu Sina</h1>
    <nav>
        <ol class="breadcrumb">
        ...
        <div class="card shadow-sm">
            <div class="card-header py-3">
                <h5 class="mb-0 fw-semibold">
                    <i class="bi bi-book-half me-2 text-primary"></i>Form Tambah Sejarah Ibnu Sina
                </h5>
            </div>
            <div class="card-body pt-4">
                ...
                <form action="{{ route('sejarah-ibnu-sina.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="d-flex gap-2 justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save me-1"></i> Simpan Sejarah
                        </button>
                    </div>
